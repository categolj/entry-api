...
class EntryControllerDirectUpdateTest {
	...
	void postEntryFromMarkdown_shouldCreateFileOnGitHub(String path, String username, String password,
		...
		// Verify entry was also saved to the repository
		assertThat(this.entryRepository.findById(entry.entryKey())).isPresent();
	}
	...
	void putEntryFromMarkdown_shouldUpdateFileOnGitHub(String path, String username, String password, String tenantId) {
		...
		// Verify entry was also updated in the repository
		assertThat(this.entryRepository.findById(entry.entryKey()))
			.hasValueSatisfying(e -> assertThat(e.frontMatter().title()).isEqualTo("Updated Entry via Direct Update"));
	}
	...
	void patchEntrySummary_shouldUpdateFileOnGitHub(String path, String username, String password, String tenantId) {
		...
		// Verify entry was also updated in the repository
		assertThat(this.entryRepository.findById(entry.entryKey()))
			.hasValueSatisfying(e -> assertThat(e.frontMatter().summary())
				.isEqualTo("This is a summary added via GitHub direct update."));
	}
	...
	void deleteEntry_shouldDeleteFileOnGitHub(String path, String username, String password, String tenantId) {
		...
		// Verify entry was also deleted from the repository
